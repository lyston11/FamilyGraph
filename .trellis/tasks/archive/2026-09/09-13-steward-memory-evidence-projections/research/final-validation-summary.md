...
SP-AC1～6 全部通过，`cff6f8e` / `b43602d` 已合入 main 并归档；任务 worktree/分支已清理。MR-26 保留重建器不拥有的冷却与未知键；MR-23 将相关支撑记录为不可变内部版本，保留稳定候选、确认和驳回历史。新证据不新增建议、收件人、通知或推测边，反向 sibling 候选同样隔离。
