...
2026-09-14：下列20组问题已在累计修复 aebee83 / dd8157c 闭合，父AC-01～10与F-01～12重新验收通过。逐项最终实现与证据见 [最终验收](final-acceptance.md)。D复核追加发现的合法index_superseded恢复回归也已修复并单列，不改写原20组计数。下面的事实、严重性、源码锚点与红测均对应原基线，保留其历史含义。
