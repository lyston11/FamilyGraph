...
## 与 09-18 的边界（2026-09-18）

请求层重试预算的具体候选（降到 1–2 次、缩短退避）在 `09-18-assistant-low-latency` 的 P1-2 跟踪，但**策略决定仍归本任务 E-R5**：未取得独立批准前不得实施，09-18 只记录候选与实测。本任务保持 in_progress，不以 09-18 的部署代替 E-R3/E-R5 的数值决策。
