...
const dshNotesDir = args[0] ? resolve(args[0]) : resolve(process.cwd(), '../deepseek-harness/.agent-notes');
const targetNotesDir = args[1] ? resolve(args[1]) : resolve(__dirname, '../.agent-notes');
...
// 拷贝 README.md 和 AGENTS.md 到 .agent-notes 根目录供相对跳转
