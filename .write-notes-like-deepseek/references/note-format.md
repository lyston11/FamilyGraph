...
来源：Harness `.agent-notes/README.md#the-file-format` 与 `implemented/process/2026-07-05-uniform-agent-note-format.md`（本项目中文单语，头块 `Agent Note:` 与 `Status:` 保持英文原文以便脚本核对，正文用中文）。
