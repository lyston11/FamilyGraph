...
STEWARD_MAX_CONCURRENT_JOBS: int = int(os.environ.get("STEWARD_MAX_CONCURRENT_JOBS", "4"))
STEWARD_SEARCH_SLICE_EXPANSIONS: int = int(
    os.environ.get("STEWARD_SEARCH_SLICE_EXPANSIONS", "2048")
)
STEWARD_SEARCH_MAX_EXPANSIONS: int = int(os.environ.get("STEWARD_SEARCH_MAX_EXPANSIONS", "2000000"))
STEWARD_SEARCH_MAX_STATE_BYTES: int = int(
    os.environ.get("STEWARD_SEARCH_MAX_STATE_BYTES", str(4 << 20))
)
STEWARD_SNAPSHOT_MAX_BYTES: int = int(os.environ.get("STEWARD_SNAPSHOT_MAX_BYTES", str(64 << 20)))
STEWARD_DELIVERY_PER_TICK: int = int(os.environ.get("STEWARD_DELIVERY_PER_TICK", "20"))
...
def _validate_steward_scheduling() -> None:
    ...
    bounds: tuple[tuple[str, int, int, int], ...] = (
        ("STEWARD_MAX_CONCURRENT_JOBS", STEWARD_MAX_CONCURRENT_JOBS, 1, 8),
        ("STEWARD_SEARCH_SLICE_EXPANSIONS", STEWARD_SEARCH_SLICE_EXPANSIONS, 64, 16384),
        ("STEWARD_SEARCH_MAX_EXPANSIONS", STEWARD_SEARCH_MAX_EXPANSIONS, 1024, 100_000_000),
        ("STEWARD_SEARCH_MAX_STATE_BYTES", STEWARD_SEARCH_MAX_STATE_BYTES, 65536, 16 << 20),
        ("STEWARD_SNAPSHOT_MAX_BYTES", STEWARD_SNAPSHOT_MAX_BYTES, 1 << 20, 256 << 20),
        ("STEWARD_DELIVERY_PER_TICK", STEWARD_DELIVERY_PER_TICK, 1, 100),
